...
import { deleteUserParamsValidator } from '../validators/delete-user.validator.js';
import validator from '../validators/index.js';
import { updateSelfDataValidator } from '../validators/update-self-data.validator.js';
import { updateUserValidator, updateUserParamsValidator } from '../validators/update-user.validator.js';
...
router.delete('/:id', ac.auth(Permission.DELETE_USER), validator.params(deleteUserParamsValidator), usersController.deleteUser);
